                                ...
                                <form action="" id="paymentForm">
                                    <div class="fields">
                                        <div class="form-control">
                                            ...
                                            <input type="text" placeholder="Full Name" id="name" value="<?php echo $selected_user['user_fname'] . " " . $selected_user['user_lname'] ?>">
                                        </div>

                                        <div class="form-control">
                                            <label for="">Email Address</label>
                                            <input type="text" placeholder="Email Address" id="email" value="<?php echo $selected_user['user_email']; ?>">
                                        </div>
                                    </div>
                                    <div class="fields">
                                        <div class="form-control">
                                            <label for="">Phone Number</label>
                                            <input type="text" placeholder="Phone Number" id="phone" value="<?php echo $selected_user['user_contact']; ?>">
                                        </div>

                                        <div class="form-control">
                                            <label for="">Address</label>
                                            <input type="text" placeholder="Address" id="address" value="<?php echo $selected_user['user_address']; ?>">
                                        </div>
                                    </div>
                                </form>
