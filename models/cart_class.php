...
class Cart extends Connection
{
    ...
    function add_cart_lg($p_id, $c_id)
    {
        return $this->query("insert into cart(p_id, ip_add, c_id) values ('$p_id', ' ', '$c_id')");
    }

    //Guest: Add to cart
    function add_cart_gst($p_id, $ip_add)
    {
        return $this->query("insert into cart(p_id, ip_add) values ('$p_id','$ip_add')");
    }
    ...
    {
        return $this->fetchOne("select count(p_id) as total from cart where c_id = '$c_id'");
    }

    //Guest: Count items in cart
    function count_cart_gst($ip_add)
    {
        return $this->fetchOne("select count(p_id) as total from cart where ip_add = '$ip_add'");
    }
