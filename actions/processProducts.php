...
if (isset($_POST['addBrand'])) {
    ...
    if ($check_brand) {
        echo "<script>alert('Brand already exists'); 
                document.location.href='../admin/admin-brands.php';
            </script>";
    } else {
        $result = add_brand_controller($brand_name);
        if ($result) {
            echo "<script>alert('Brand has been added'); document.location.href='../admin/admin-brands.php';</script>";
        } else {
            echo "<script>alert('Failed to add brand'); document.location.href='../admin/admin-brands.php';</script>";
        }
    }
}
...
if (isset($_GET['deleteBrandID'])) {
    ...
    if ($result) {
        echo "<script>alert('Brand deleted successfully'); document.location.href='../admin/admin-brands.php';</script>";
    } else {
        echo "<script>alert('Failed to delete brand'); document.location.href='../admin/admin-brands.php';</script>";
    }
}
// --------------------------------------------BRAND ENDS------------------------------------------------------
...
if (isset($_POST['addCategory'])) {
    ...
    if ($check_category) {
        echo "<script>alert('Category already exists'); 
                document.location.href='../admin/admin-categories.php';
            </script>";
    } else {
        $result = add_category_controller($cat_name);
        if ($result) {
            echo "<script>alert('Category has been added'); document.location.href='../admin/admin-categories.php';</script>";
        } else {
            echo "<script>alert('Failed to add category'); document.location.href='../admin/admin-categories.php';</script>";
        }
    }
}
...
if (isset($_GET['deleteCatID'])) {
    ...
    if ($result) {
        echo "<script>alert('Category deleted successfully'); document.location.href='../admin/admin-categories.php';</script>";
    } else {
        echo "<script>alert('Failed to delete category'); document.location.href='../admin/admin-categories.php';</script>";
    }
}
        ...
        if (empty($_FILES["image"]["name"])) {
            ...
            if ($image_upload) {
                ...
                if ($addProduct == true) {
                    ...
                    document.location.href = '../admin/admin-addproducts.php';
                    </script>";
                } else {
